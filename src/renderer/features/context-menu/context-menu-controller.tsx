...
const Controller = createCallable<ContextMenuControllerProps, void>(({ call, cmd, event }) => {
...
const Wrapper = (props: ContextMenuControllerProps) => Controller.call(props, undefined as any);
Wrapper.call = (props: ContextMenuControllerProps) => Controller.call(props, undefined as any);
Wrapper.Root = Controller.Root;

export const ContextMenuController = Wrapper;
