...
import { LibraryItem, ServerType, SongListSort, SortOrder } from '/@/shared/types/domain-types';
...
export const PlaylistDetailSongListHeaderFilters = ({
    ...
    const defaultSortBy =
        server?.type === ServerType.EMBY ? SongListSort.LIST_ITEM_ORDER : SongListSort.ID;
