...
type ApiController = {
    emby: InternalControllerEndpoint;
...
const apiController = <K extends keyof ControllerEndpoint>(endpoint: K, type?: ServerType): any => {
    ...
    const controllerFn = (endpoints?.[serverType] as any)?.[endpoint] as
        | ((...args: any[]) => any)
        | undefined;
